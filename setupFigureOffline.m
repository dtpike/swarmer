function handles = SetupFigureOffline(handles)
...
%==========================================================================
global targets robots generated_targets targetsServiced numRobots obstacles VERSION areaSize robot_positions
