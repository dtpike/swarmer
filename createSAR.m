function ProblemInstance = createSAR(handles)

handles.NUM_TARGETS = 1;

handles.NUM_INITIAL_TARGETS = handles.NUM_TARGETS;
...
for i = 1:handles.NUM_TARGETS
    ...
    generated_targets(i).UID = UID;
    UID = UID + 1;
    generated_targets(i).EXPECTED_SERVICE_TIME = Inf;
end
...
ProblemInstance.ROBOT_POSITIONS = robot_positions;
